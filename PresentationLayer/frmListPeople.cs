...
namespace DVLD
{
    public partial class frmListPeople : Form
    {
        ...
        private void frmListPeople_Load(object sender, EventArgs e)
        {
            ...
            dGVListPeople.DataSource = clsPerson.GetAllPeople(comboBox1.SelectedValue.ToString());
        ...
        {
            if (comboBox1.SelectedValue.ToString() == "Person ID")
            {
            ...
            dGVListPeople.DataSource = clsPerson.GetAllPeople(comboBox1.SelectedValue.ToString(),textBox1.Text);
            LbRecords.Text = dGVListPeople.RowCount.ToString();
        }

        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox1.SelectedValue.ToString() != "None")
            {
                textBox1.Visible = true;
            }
        }
        private void RefreshDataGridView(object sender)
        {
            dGVListPeople.DataSource = clsPerson.GetAllPeople(comboBox1.SelectedValue.ToString(), textBox1.Text);
            LbRecords.Text = dGVListPeople.RowCount.ToString();
        }
