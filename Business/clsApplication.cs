...
namespace DVLD_Business
{
    public class clsApplication
    {
        ...
        private clsApplication(int applicationID, int applicantPersonID, DateTime applicationDate, int applicationTypeID, byte applicationStatus, DateTime lastStatusDate, float paidFees, int createdByUserID)
        {
            ...
            ApplicationTypeInfo = clsApplicationType.GetApplicationTypeInfoByID(applicationTypeID);
            ApplicationStatus = applicationStatus;
            LastStatusDate = lastStatusDate;
            PaidFees = paidFees;
            CreatedByUserID = createdByUserID;
            CreatedByUserInfo = clsUser.GetUserInfoByID(createdByUserID);
        }
        ...
        public bool Save()
        {
            ...
            {
                ApplicantPersonInfo = clsPerson.GetPersonInfoByID(this.ApplicantPersonID);
                ApplicationTypeInfo = clsApplicationType.GetApplicationTypeInfoByID(this.ApplicationTypeID);
