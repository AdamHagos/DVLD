...
namespace DVLD_Business
{
    public class clsInternationalLicense
    {
        ...
        public static bool DoesDriverHaveInternationalLicense(ref int LocalLicenseID)
        {
            LocalLicenseID = clsInternationalLicensesDataAccess.DoesDriverHaveInternationalLicense(LocalLicenseID);
            return LocalLicenseID != -1; 
        }
