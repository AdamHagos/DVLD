...
namespace DVLD_DataAccess
{
    public class clsInternationalLicensesDataAccess
    {
        ...
        public static int DoesDriverHaveInternationalLicense(int LocalLicenseID)
        {
            int InternationalLicenseID = -1;
            ...
            string Query = @"select InternationalLicenseID from InternationalLicenses
                             where CAST(GETDATE() AS DATE) < ExpirationDate AND IssuedUsingLocalLicenseID = @IssuedUsingLocalLicenseID";
